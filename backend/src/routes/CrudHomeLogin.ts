...
// Tipos da aplicação que estendem RowDataPacket
...
export const getUserProjects = async (req: Request, res: Response) => {
    ...
    try {
      ...
      const formattedProjects = projects.map(project => ({
        ...project,
        data_inicio_proj: formatDate(project.data_inicio_proj),
        data_fim_proj: formatDate(project.data_fim_proj),
...
export const getProjectDetails = async (req: Request, res: Response) => {
    ...
    try {
      ...
      const response = {
        ...project[0],
        data_inicio_proj: formatDate(project[0].data_inicio_proj),
        data_fim_proj: formatDate(project[0].data_fim_proj),
        user_role: userRole,
        responsavel: userRole === 'responsavel' ? 'Você' : 'Equipe',
