...
import { getUserProjects, createProject, getProjectDetails, updateProject, deleteProject, addParticipant, removeParticipant } from './routes/CrudHomeLogin.js'; // Adicione esta linha
const app = express();
