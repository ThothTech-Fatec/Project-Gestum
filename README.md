...
10|Alta|Como coordenador, quero visualizar projetos pelo status para acompanhar seu progresso.|5 Pontos|2|Visualizar projetos pelo status|-Os projetos são exibidos com status.<br>-A visualização do status é atualizada automaticamente conforme mudanças no progresso do projeto.|❌
